...
- 📦 **第三方库** - 开源第三方组件
- 🔧 **应用模块** - 需要特定库组合或项目配置
- 🎯 **平台标识** - [STM32] / [STC16] / [Linux] / [PC] / [Python] / [通用]
...
这是一个个人整理的通用代码库，收集了从各个项目、网友、开源社区积累的代码片段和工具模块。目标是建立一个"包罗万象"的代码仓库，方便快速复用。
...
1. **按需取用**：每个模块独立，不需要全部下载
2. **仔细阅读README**：每个模块都有详细文档和使用说明
3. **注意平台限制**：查看"平台"列确认是否适用
4. **修改配置**：硬件依赖模块需要修改IO和外设配置
5. **测试验证**：代码仅供参考，使用前请充分测试
